				...
				<div id="carouselId" class="carousel slide position-relative"
					...
					<div class="carousel-inner" role="listbox">
						<div class="carousel-item active rounded">
							<img src="public/img/hero-img-1.png"
								class="img-fluid w-100 h-100 bg-secondary rounded"
								alt="First slide" /> <a href="#"
								class="btn px-4 py-2 text-white rounded">Fruites</a>
						</div>
						<div class="carousel-item rounded">
							<img src="public/img/hero-img-2.jpg"
								class="img-fluid w-100 h-100 rounded" alt="Second slide" /> <a
								href="#" class="btn px-4 py-2 text-white rounded">Vesitables</a>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="row g-4">
								...
								<div class="col-md-6 col-lg-4 col-xl-3">
									<div class="rounded position-relative fruite-item">
										<div class="fruite-img">
											<a href="Detail_Product?id=<%=fruit.getId()%>"> <img
						...
						<div class="col-lg-12">
							<div class="row g-4">
								...
								<div class="col-md-6 col-lg-4 col-xl-3">
									<div class="rounded position-relative fruite-item">
										<div class="fruite-img">
											<a href="Detail_Product?id=<%=Bread.getId()%>"> <img
						...
						<div class="col-lg-12">
							<div class="row g-4">
								...
								<div class="col-md-6 col-lg-4 col-xl-3">
									<div class="rounded position-relative fruite-item">
										<div class="fruite-img">
											<a href="Detail_Product?id=<%=meat.getId()%>"> <img
			...
			<div class="col-md-6 col-lg-4">
				<a href="#">
					<div
						...
						<img src="public/img/featur-1.jpg"
			...
			<div class="col-md-6 col-lg-4">
				<a href="#">
					<div class="service-item bg-dark rounded border border-dark">
						<img src="public/img/featur-2.jpg"
							class="img-fluid rounded-top w-100" alt="" />
						<div class="px-4 rounded-bottom">
			...
			<div class="col-md-6 col-lg-4">
				<a href="#">
					<div class="service-item bg-primary rounded border border-primary">
						<img src="public/img/featur-3.jpg"
							class="img-fluid rounded-top w-100" alt="" />
						<div class="px-4 rounded-bottom">
		...
		<div class="row g-4 align-items-center">
			...
			<div class="col-lg-6">
				<div class="position-relative">
					<img src="public/img/baner-1.png" class="img-fluid w-100 rounded"
						alt="" />
					<div
						...
						<div class="d-flex flex-column">
							<span class="h2 mb-0">50$</span> <span class="h4 text-muted mb-0">kg</span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="position-relative">
					...
					<div class="d-flex align-items-center flex-nowrap">
						<div class="bg-secondary rounded">
							<img src="public/img/testimonial-1.jpg" class="img-fluid rounded"
