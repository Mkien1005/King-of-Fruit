     <!-- Spinner Start -->
        ...
        %>
					<tr>
						<th>
							<div class="cntr">
								<input type="checkbox" id="<%=products.getProduct().getId()%>" class="input-checkbox hidden-xs-up">
                        ...
                        <div class="bg-light rounded">
                            <div class="p-4">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <p class="mb-0">$<span class="sub-total"></span></p>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-0 me-4">Shipping</h5>
                                    <div class="">
                                        <p class="mb-0">Flat rate: $<span class="ship-fee">3.00</span></p>
                                    </div>
                                </div>
                            ...
                            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                ...
                                <p class="mb-0 pe-4">$<span class="total"></span></p>
                            </div>
